...
- **Probe23 (TC 3.1)**: compiled; 16-bit records folded.  See RULES.md C27.


## Probe24: Findings 37-43 primitives (round 21)

- **Probe24 (TC 3.1)**: compiled; 16-bit records folded.  See RULES.md C29.


## Probe25: Finding 44 primitives (round 22)

- **Probe25 (TC 3.1)**: compiled; 16-bit records folded.  See RULES.md C30.


## Probe26: Finding 45 early-return placement (round 23)

- **Probe26 (TC 3.1)**: compiled; 16-bit records folded.  See RULES.md F25.


## Probe27: Findings 46-50 primitives (round 24)

- **Probe27 (TC 3.1)**: compiled; 16-bit records folded.  See RULES.md C32.


## Probe28: decompedia/CODEGEN_PATTERNS claims (round 25)

- **Probe28 (TC 3.1)**: compiled; 16-bit records folded.  See RULES.md D10.
