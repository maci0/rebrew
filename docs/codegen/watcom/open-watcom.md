...
- **Probe22 (Watcom)**: 16-bit `wcc` compiles with `-I/tmp/cur_wc/h`; 32-bit object resists symbol listing (raw fold).  See RULES.md E14.


## Probe23: Findings 23-36 shapes (round 20)

- **Probe23 (Watcom)**: 16-bit `wcc` compiled; 32-bit object resists symbol listing (raw fold).  See RULES.md C28.


## Probe24: Findings 37-43 primitives (round 21)

- **Probe24 (Watcom)**: 16-bit `wcc` compiled; 32-bit object resists symbol listing (raw fold).  See RULES.md C29.


## Probe25: Finding 44 primitives (round 22)

- **Probe25 (Watcom)**: 16-bit `wcc` compiled; 32-bit object resists symbol listing (raw fold).  See RULES.md C30.


## Probe26: Finding 45 early-return placement (round 23)

- **Probe26 (Watcom)**: 16-bit `wcc` compiled; 32-bit object resists symbol listing (raw fold).  See RULES.md F25.
