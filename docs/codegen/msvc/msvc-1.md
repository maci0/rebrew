...
- **Probe22 (16-bit)**: probe22 compiled with `string.h` via `/IZ:\opt\msvc152\INCLUDE`; the memset/memcpy intrinsic shapes (E11/E14) compile; 26 records folded.  See RULES.md E14.


## Probe23: Findings 23-36 shapes (round 20)

- **Probe23 (16-bit)**: compiled; the idx family / div / addfold shapes fold into the 16-bit forms; records folded.  See RULES.md C27/E17.


## Probe24: Findings 37-43 primitives (round 21)

- **Probe24 (16-bit)**: compiled; word ops fold into the 16-bit forms; records folded.  See RULES.md C29.


## Probe25: Finding 44 primitives (round 22)

- **Probe25 (16-bit)**: compiled; records folded.  See RULES.md C30.


## Probe26: Finding 45 early-return placement (round 23)

- **Probe26 (16-bit)**: compiled; records folded.  See RULES.md F25.
