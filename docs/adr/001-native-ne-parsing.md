...
- Byte matching for 16-bit targets remains future work (needs a real 16-bit
  compiler + segment-relative reloc comparison) — the loader is analysis/
  documentation-grade, which is the current goal.
