...
| Document | Description |
|----------|-------------|
| [CLI.md](CLI.md) | All 28 CLI commands — flags, examples, internal modules |
...
| [GA_MUTATIONS.md](GA_MUTATIONS.md) | All 120 GA mutation operators — categories, rationale, discovery origins |
