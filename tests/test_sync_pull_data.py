"""Tests for rebrew sync --pull-data (Ghidra data label fetching)."""

import sys
from types import SimpleNamespace
from typing import Any

from rebrew.ghidra.commands import pull_data
...
def _runpull_data(
    ...
    *,
    ...
    pull_data(cfg, "http://localhost:8080/mcp/message", "/target.exe", dry_run)
...
class TestPullDataGlobalsHeader:
    ...
    def test_filters_function_symbols(self, tmp_path: Any, monkeypatch: Any) -> None:
        ...
        pull_data(cfg, "http://localhost:8080/mcp/message", "/target.exe", False)
    ...
    def test_dry_run_no_write(self, tmp_path: Any, monkeypatch: Any, capsys: Any) -> None:
        ...
        _runpull_data(monkeypatch, tmp_path, symbols, data_by_addr, dry_run=True)
    ...
    def test_empty_symbols_no_file(self, tmp_path: Any, monkeypatch: Any) -> None:
        _runpull_data(monkeypatch, tmp_path, [], {}, dry_run=False)
        assert not (tmp_path / "rebrew_globals.h").exists()
