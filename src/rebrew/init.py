...
COMPILER_DEFAULTS: dict[str, dict[str, str]] = {
    ...
    "msvc700": {
        "runner": "wine",
        "command": "wine toolchain/msvc/7.0-rtm-win32/Vc7/bin/cl.exe",
        "includes": "toolchain/msvc/7.0-rtm-win32/Vc7/include",
        "libs": "toolchain/msvc/7.0-rtm-win32/Vc7/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc700sp1": {
        "runner": "wine",
        "command": "wine toolchain/msvc/7.0-sp1-win32/Vc7/bin/cl.exe",
        "includes": "toolchain/msvc/7.0-sp1-win32/Vc7/include",
        "libs": "toolchain/msvc/7.0-sp1-win32/Vc7/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc710": {
        "runner": "wine",
        "command": "wine toolchain/msvc/7.1-win32/Vc7/bin/cl.exe",
        "includes": "toolchain/msvc/7.1-win32/Vc7/include",
        "libs": "toolchain/msvc/7.1-win32/Vc7/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc710sp1": {
        "runner": "wine",
        "command": "wine toolchain/msvc/7.1-sp1-win32/Vc7/bin/cl.exe",
        "includes": "toolchain/msvc/7.1-sp1-win32/Vc7/include",
        "libs": "toolchain/msvc/7.1-sp1-win32/Vc7/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc800": {
        "runner": "wine",
        "command": "wine toolchain/msvc/8.0-win32/VC/bin/cl.exe",
        "includes": "toolchain/msvc/8.0-win32/VC/include",
        "libs": "toolchain/msvc/8.0-win32/VC/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc800sp1": {
        "runner": "wine",
        "command": "wine toolchain/msvc/8.0-sp1-win32/VC/bin/cl.exe",
        "includes": "toolchain/msvc/8.0-sp1-win32/VC/include",
        "libs": "toolchain/msvc/8.0-sp1-win32/VC/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc900": {
        "runner": "wine",
        "command": "wine toolchain/msvc/9.0-win32/VC/bin/cl.exe",
        "includes": "toolchain/msvc/9.0-win32/VC/include",
        "libs": "toolchain/msvc/9.0-win32/VC/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc1000": {
        "runner": "wine",
        "command": "wine toolchain/msvc/10.0-win32/VC/bin/cl.exe",
        "includes": "toolchain/msvc/10.0-win32/VC/include",
        "libs": "toolchain/msvc/10.0-win32/VC/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc1000sp1": {
        "runner": "wine",
        "command": "wine toolchain/msvc/10.0-sp1-win32/VC/bin/cl.exe",
        "includes": "toolchain/msvc/10.0-sp1-win32/VC/include",
        "libs": "toolchain/msvc/10.0-sp1-win32/VC/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc200": {
        "runner": "wine",
        "command": "wine toolchain/msvc/2.0-win32/bin/cl.exe",
        "includes": "toolchain/msvc/2.0-win32/include",
        "libs": "toolchain/msvc/2.0-win32/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc410": {
        "runner": "wine",
        "command": "wine toolchain/msvc/4.1-win32/bin/CL.EXE",
        "includes": "toolchain/msvc/4.1-win32/include",
        "libs": "toolchain/msvc/4.1-win32/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc500sp1": {
        "runner": "wine",
        "command": "wine toolchain/msvc/5.0-sp1-win32/bin/cl.exe",
        "includes": "toolchain/msvc/5.0-sp1-win32/include",
        "libs": "toolchain/msvc/5.0-sp1-win32/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc500sp2": {
        "runner": "wine",
        "command": "wine toolchain/msvc/5.0-sp2-win32/bin/cl.exe",
        "includes": "toolchain/msvc/5.0-sp2-win32/include",
        "libs": "toolchain/msvc/5.0-sp2-win32/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc500sp3": {
        "runner": "wine",
        "command": "wine toolchain/msvc/5.0-sp3-win32/bin/cl.exe",
        "includes": "toolchain/msvc/5.0-sp3-win32/include",
        "libs": "toolchain/msvc/5.0-sp3-win32/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc600sp1": {
        "runner": "wine",
        "command": "wine toolchain/msvc/6.0-sp1-win32/VC98/bin/CL.EXE",
        "includes": "toolchain/msvc/6.0-sp1-win32/VC98/include",
        "libs": "toolchain/msvc/6.0-sp1-win32/VC98/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc600sp2": {
        "runner": "wine",
        "command": "wine toolchain/msvc/6.0-sp2-win32/VC98/bin/CL.EXE",
        "includes": "toolchain/msvc/6.0-sp2-win32/VC98/include",
        "libs": "toolchain/msvc/6.0-sp2-win32/VC98/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc600sp4": {
        "runner": "wine",
        "command": "wine toolchain/msvc/6.0-sp4-win32/VC98/bin/CL.EXE",
        "includes": "toolchain/msvc/6.0-sp4-win32/VC98/include",
        "libs": "toolchain/msvc/6.0-sp4-win32/VC98/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc600sp5": {
        "runner": "wine",
        "command": "wine toolchain/msvc/6.0-sp5-win32/VC98/Bin/CL.EXE",
        "includes": "toolchain/msvc/6.0-sp5-win32/VC98/Include",
        "libs": "toolchain/msvc/6.0-sp5-win32/VC98/Lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc900sp1": {
        "runner": "wine",
        "command": "wine toolchain/msvc/9.0-sp1-win32/VC/bin/cl.exe",
        "includes": "toolchain/msvc/9.0-sp1-win32/VC/include",
        "libs": "toolchain/msvc/9.0-sp1-win32/VC/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc1100": {
        "runner": "wine",
        "command": "wine toolchain/msvc/11.0-win32/VC/bin/cl.exe",
        "includes": "toolchain/msvc/11.0-win32/VC/include",
        "libs": "toolchain/msvc/11.0-win32/VC/lib",
        "cflags": "/O2 /Gd",
        "base_cflags": "/nologo /c /MT",
        "format": "pe",
        "arch": "x86_32",
    ...
    "msvc15": {
        "runner": "",
        "command": "toolchain/msvc/1.5-win16/BIN/CL.EXE",
        "includes": "toolchain/msvc/1.5-win16/INCLUDE",
        "libs": "toolchain/msvc/1.5-win16/LIB",
        "cflags": "/O1",
    ...
    "msvc10": {
        "runner": "",
        "command": "toolchain/msvc/1.0-win16/BIN/CL.EXE",
        "includes": "toolchain/msvc/1.0-win16/INCLUDE",
        "libs": "toolchain/msvc/1.0-win16/LIB",
        "cflags": "/O1",
        "base_cflags": "/nologo /c",
        "format": "pe",
        "arch": "x86_16",
