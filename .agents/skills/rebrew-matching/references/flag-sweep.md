...
rebrew match src/bench/<file>.c --flag-sweep-only --tier thorough      # product 258k; auto-sampled — ask first
rebrew match src/bench/<file>.c --flag-sweep-only --tier full          # product 6.2M; auto-sampled to ~100k — ask first
```
